...
INSERT INTO Linguagem (tipo) VALUES ('Inglês'), ('Português'), ('Espanhol'), ('Francês'), ('Mandarim');

CREATE TABLE Pais (
    paisID INT PRIMARY KEY AUTO_INCREMENT,
    numIdentificar INT
);
INSERT INTO Pais (numIdentificar) VALUES (1), (55), (34), (33), (86);

CREATE TABLE GeneroFilme (
    generoID INT PRIMARY KEY AUTO_INCREMENT,
    tipo VARCHAR(255)
);
INSERT INTO GeneroFilme (tipo) VALUES ('Ação'), ('Drama'), ('Comédia'), ('Terror'), ('Romance'), ('Ficção Científica'), ('Aventura'), ('Animação'), ('Suspense'), ('Documentário');
...
INSERT INTO Produtora (nome, ceo, origem) VALUES 
...
CREATE TABLE Filme (
    ...
    produtoraID INT DEFAULT NULL,
    FOREIGN KEY (produtoraID) REFERENCES Produtora(produtoraID)
);


INSERT INTO Filme (titulo, atores, diretor, ano, genero, produtora, sinopse, orcamento, tempoDuracao, poster, linguagemID, paisID, generoID, produtoraID) VALUES 
